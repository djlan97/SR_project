...
class box_and_target_positionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.c1, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.uint8(obj.c2, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.uint8(obj.c3, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.uint8(obj.c4, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.c1 = _deserializer.uint8(buffer, bufferOffset);
    ...
    data.c2 = _deserializer.uint8(buffer, bufferOffset);
    ...
    data.c3 = _deserializer.uint8(buffer, bufferOffset);
    ...
    data.c4 = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
...
module.exports = {
  ...
  md5sum() { return '305b8cdaf6eafb69d6dc3217db2db095'; },
